...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-ui/src/queries/queries.ts
  var queryProduct = (productId) => `
  {
    node(id: "${productId}") {
      ... on Product {
        options(first:3) {
...
`;
  ...
  // extensions/checkout-ui/src/component/ModalProduct.tsx
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var React = require_react();
  var ModalProduct = ({ values, cartLine, variants, handleCartChange }) => {
    const { ui } = useApi();
    const currentVariant = cartLine.merchandise.selectedOptions.map((options, index) => {
      return { position: index + 1, option: options.value };
    });
    const [variant, setVariant] = React.useState(currentVariant);
    const [newCartLine, setNewCartLine] = React.useState(null);
    const handleChange = ({ position, value }) => {
      setVariant((prev) => {
        const newVariant = prev.map((element, index) => {
          if (index === position - 1) {
            return __spreadProps(__spreadValues({}, element), { option: value });
          }
          return element;
        });
        return newVariant;
      });
      const currentTitle = variant.map((variant2) => variant2.option).join(" / ");
      handleFindVariant(currentTitle.trim());
    };
    const handleFindVariant = (titleVariant) => {
      const newVariant = variants.find((variant2) => variant2.title === titleVariant);
      if (newVariant)
        setNewCartLine(newVariant);
    };
      ...
      Pressable2,
      {
        ...
        overlay: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          Modal2,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockLayout2, { rows: "auto", children: [
              values.map((value) => {
                return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { padding: ["base", "none", "base", "none"], children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Grid2, { rows: "auto", padding: ["base", "none"], children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: value.name }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineLayout2, { padding: "base", spacing: "base", children: value.values.map((option) => {
                      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                        Button2,
                        {
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: option })
                        },
                        React.useId()
                      );
                    }) })
              ...
              newCartLine && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                Pressable2,
                {
                  inlineAlignment: "center",
                  ...
                  children: "Change variant"
                }
              )
            ] })
          }
        ),
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Change variant" })
      }
    );
  };
  var ModalProduct_default = ModalProduct;

  // extensions/checkout-ui/src/component/Quantity.tsx
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var React2 = require_react();
  var Quantity = ({ cartLine, handleCartChange }) => {
    const [currentQuantity, setCurrentQuantity] = React2.useState(
      cartLine.quantity
    );
    ...
    const updateCartLine = React2.useCallback(() => {
      handleCartChange({
        id: cartLine.id,
        type: "updateCartLine",
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Grid2, { columns: [20, 30, 20, 10, 30], rows: [50], blockAlignment: "center", children: [
        ...
        View2,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            Pressable2,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon2, { source: "minus", size: "base" })
            }
          )
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { children: currentQuantity }) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        View2,
        {
          border: "base",
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            Pressable2,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon2, { source: "plus", size: "base" })
            }
          )
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(InlineSpacer2, { spacing: "base" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { blockAlignment: "center", inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Pressable2, { onPress: () => handleRemove(), accessibilityLabel: "delete", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon2, { source: "delete", size: "base" }) }) })
    ] });
  };
  var Quantity_default = Quantity;

  // extensions/checkout-ui/src/component/Selector.tsx
  ...
  var Selector = ({
    ...
    const [currentPlan, setCurrentPlan] = React3.useState(
      cartLine.merchandise.sellingPlan ? cartLine.merchandise.sellingPlan.id : ""
    );
    const handlePlan = (currentPlan2) => {
      setCurrentPlan(currentPlan2);
      handleCartChange({
        id: cartLine.id,
        type: "updateCartLine",
        sellingPlanId: currentPlan2 ? currentPlan2 : null
      });
    };
  ...
  // extensions/checkout-ui/src/CartLineActions.tsx
  var import_jsx_runtime7 = __toESM(require_jsx_runtime());
  var React4 = require_react();
  var CartLineActions_default = reactExtension(
  ...
  function Extension() {
    ...
    const [linePlans, setLinePlans] = React4.useState(null);
    const [values, setValues] = React4.useState(null);
    const [variants, setVariants] = React4.useState(null);
    const handleCartChange = (config) => {
      applyCartLinesChange(config);
    };
    React4.useEffect(() => {
      if (!cartLine)
        return;
      const getVarintData = () => __async(this, null, function* () {
        try {
          const productId = cartLine.merchandise.product.id;
          const response = yield query(queryProduct(productId));
          ...
          if (response.data.node.sellingPlanGroups.edges[0]) {
            const nodePlans = response.data.node.sellingPlanGroups.edges[0].node.sellingPlans.edges;
            if (nodePlans) {
    ...
    if (!cartLine)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Grid2, { columns: ["1fr", "1fr"], padding: ["base", "none"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GridItem2, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        Quantity_default,
        {
          cartLine,
          handleCartChange
      ...
      linePlans && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GridItem2, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        Selector_default,
        {
          cartLine,
          linePlans,
      ...
      values && variants && variants.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GridItem2, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        ModalProduct_default,
        {
          variants,
          cartLine,
          values,
